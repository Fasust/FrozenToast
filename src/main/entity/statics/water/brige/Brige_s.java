...
public class Brige_s extends Brige {

	public Brige_s(Handler hand, float x, float y) {
		super(hand,IdManager.Brige_s, x, y);
	...
	protected void renderWaterBorder(Graphics g) {
		...
		g.drawImage(Assets.water_br_s, (int)(x-hand.getCam().getxOffset()), 
				(int) (y-hand.getCam().getyOffset()),breite,hoehe, null);
