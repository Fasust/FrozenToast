...
public class StoneDoor_s_iron extends StaticEntity{
	
	private boolean closed = true;
	private boolean fristOpen = false;
	private boolean fristClose = false;
	
	public StoneDoor_s_iron(Handler hand, float x, float y) {
		super(hand,IdManager.StoneDoor_s_iron, x*Tile.TILEBREITE, y*Tile.TILEHoeHE,Tile.TILEBREITE,Tile.TILEHoeHE);
		this.semiSolid = true;
	...
	public void render(Graphics g) {
		if(closed){
			g.drawImage(Assets.stone_door_s_iron, (int)(x-hand.getCam().getxOffset()), 
