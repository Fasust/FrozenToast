...
public class StoneStairs_down extends StaticEntity{
	private boolean stairsStepedOn = false;

	public StoneStairs_down(Handler hand, float x, float y) {
		super(hand,IdManager.StoneStairs_down, x*Tile.TILEBREITE, y*Tile.TILEHoeHE,Tile.TILEBREITE,Tile.TILEHoeHE);
	...
	public void render(Graphics g) {
		g.drawImage(Assets.stone_stairs_down, (int)(x-hand.getCam().getxOffset()), 
